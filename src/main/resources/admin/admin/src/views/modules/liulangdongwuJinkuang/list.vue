        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '近况标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.liulangdongwuJinkuangName" placeholder="近况标题" clearable></el-input>
                     </el-form-item>
                         
                     <el-form-item :label="contents.inputTitle == 1 ? '流浪动物状态' : ''">
                        <el-select v-model="searchForm.liulangdongwuJinkuangTypes" placeholder="请选择流浪动物状态">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in liulangdongwuJinkuangTypesSelectSearch"
                               v-bind:key="index"
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '详细类型' : ''">
                        <el-select v-model="searchForm.liulangdongwuErjiTypes" placeholder="请选择详细类型">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                                    v-for="(item,index) in liulangdongwuErjiTypesSelectSearch"
                                    v-bind:key="index"
                                    :label="item.indexName"
                                    :value="item.codeIndex">
                                <!--lable是要展示的名称-->
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        <el-button
                                v-if="isAuth('liulangdongwuJinkuang','新增')"
                                type="success"
                                icon="el-icon-plus"
                        ...
                        &nbsp;
                        <el-button
                                v-if="isAuth('liulangdongwuJinkuang','删除')"
                        ...
                        &nbsp;
                        <el-button
                                v-if="isAuth('liulangdongwuJinkuang','报表')"
                                type="success"
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           v-if="isAuth('liulangdongwuJinkuang','导入导出')"
                           icon="el-icon-download"
                           href="http://localhost:8080/liulangdongwujiuzhu/upload/liulangdongwuJinkuangMuBan.xls"
                        >批量导入流浪动物近况数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('liulangdongwuJinkuang','导入导出')"
                                ...
                                :action="getActionUrl"
                                :on-success="liulangdongwuJinkuangUploadSuccess"
                                :on-error="liulangdongwuJinkuangUploadError"
                                :show-file-list = false>
                            <el-button
                                    v-if="isAuth('liulangdongwuJinkuang','导入导出')"
                                    type="success"
                                    icon="el-icon-upload2"
                            >批量导入流浪动物近况数据</el-button>
                        </el-upload>
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('liulangdongwuJinkuang','导入导出')" style="display: inline-block" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "liulangdongwuJinkuang.xls">
                            <!-- 导出excel -->
                            <el-button
                                    type="success"
                                    icon="el-icon-download"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                          ...
                          v-if="isAuth('liulangdongwuJinkuang','查看')"
                          :data="dataList"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="liulangdongwuErjiTypes"
                                      header-align="center"
                                      label="详细类型">
                        <template slot-scope="scope">
                            {{scope.row.liulangdongwuErjiValue}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="yonghuName"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="liulangdongwuJinkuangUuidNumber"
                                   header-align="center"
                                   label="流浪动物近况编号">
                        <template slot-scope="scope">
                            {{scope.row.liulangdongwuJinkuangUuidNumber}}
                        </template>
                    </el-table-column>

                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="liulangdongwuJinkuangName"
                                   header-align="center"
                                   label="近况标题">
                        <template slot-scope="scope">
                            {{scope.row.liulangdongwuJinkuangName}}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="liulangdongwuJinkuangPhoto"
                                     header-align="center"
                                     width="200"
                                     label="宠物照片">
                        <template slot-scope="scope">
                            <div v-if="scope.row.liulangdongwuJinkuangPhoto">
                                <img :src="$base.url+scope.row.liulangdongwuJinkuangPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="liulangdongwuJinkuangAddress"
                                   header-align="center"
                                   label="记录地点">
                        <template slot-scope="scope">
                            {{scope.row.liulangdongwuJinkuangAddress}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="liulangdongwuJinkuangTypes"
                                      header-align="center"
                                      label="流浪动物状态">
                        <template slot-scope="scope">
                            {{scope.row.liulangdongwuJinkuangValue}}
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('liulangdongwuJinkuang','查看')" type="success" icon="el-icon-tickets" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
                            <el-button v-if="isAuth('liulangdongwuJinkuang','修改')" type="primary" icon="el-icon-edit" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
                            <el-button v-if="isAuth('liulangdongwuJinkuang','删除')" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
...
<script>
    ...
    //当前表下拉框搜索条件
              liulangdongwuJinkuangTypesSelectSearch : [],
            form:{
                id : null,
                liulangdongwuId : null,
                yonghuId : null,
                liulangdongwuJinkuangUuidNumber : null,
                liulangdongwuJinkuangName : null,
                liulangdongwuJinkuangPhoto : null,
                liulangdongwuJinkuangAddress : null,
                liulangdongwuJinkuangTypes : null,
                jiluTime : null,
                liulangdongwuJinkuangContent : null,
                insertTime : null,
                createTime : null,
            },
            dataList: [],
            ...
            json_fields: {
                //级联表字段
                     ...
                     '账户状态': 'jinyongTypes',
                //本表字段
                     '流浪动物近况编号': "liulangdongwuJinkuangUuidNumber",
                     '近况标题': "liulangdongwuJinkuangName",
                     '宠物照片': "liulangdongwuJinkuangPhoto",
                     '记录地点': "liulangdongwuJinkuangAddress",
                     '流浪动物状态': "liulangdongwuJinkuangValue",
                     '记录时间': "jiluTime",
                     '录入时间': "insertTime",
            },
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'liulangdongwu_jinkuang',//当前表表名,
                        sumColum : 'liulangdongwu_jinkuang_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'liulangdongwu_jinkuang_name',//分组字符串字段
                        // types : 'liulangdongwu_jinkuang_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //         groupColumn: "liulangdongwu_jinkuang_types",
                //     }
                //     this.$http({
            ...
            getDataList() {
                ...
                if (this.searchForm.liulangdongwuJinkuangName!= '' && this.searchForm.liulangdongwuJinkuangName!= undefined) {
                    params['liulangdongwuJinkuangName'] = '%' + this.searchForm.liulangdongwuJinkuangName + '%'
                }
                         
                if (this.searchForm.liulangdongwuJinkuangTypes!= '' && this.searchForm.liulangdongwuJinkuangTypes!= undefined) {
                    params['liulangdongwuJinkuangTypes'] = this.searchForm.liulangdongwuJinkuangTypes
                }
                                
                params['liulangdongwuJinkuangDelete'] = 1// 逻辑删除字段 1 未删除 2 删除


                this.$http({
                    url: "liulangdongwuJinkuang/page",
                    method: "get",
                    params: params
                }).then(({data}) => {
                    if(data && data.code === 0){
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=liulangdongwu_jinkuang_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.liulangdongwuJinkuangTypesSelectSearch = data.data.list;
                    }
                });
            },
            //每页数
            ...
            deleteHandler(id) {
                ...
                this.$confirm(`确定进行[${id ? "删除" : "批量删除"}]操作?`, "提示", {
                    ...
                    this.$http({
                        url: "liulangdongwuJinkuang/delete",
                        method: "post",
                        data: ids
                    }).then(({data}) => {
                        if(data && data.code === 0){
            ...
            // 导入功能上传文件成功后调用导入方法
            liulangdongwuJinkuangUploadSuccess(data){
                let _this = this;
                _this.$http({
                    url: "liulangdongwuJinkuang/batchInsert?fileName=" + data.file,
                    method: "get"
                }).then(({data}) => {
                    if(data && data.code === 0){
                        _this.$message({
                            message: "导入流浪动物近况数据成功",
                            type: "success",
                            duration: 1500,
                            onClose: () => {
                                _this.search();
            ...
            // 导入功能上传文件失败后调用导入方法
            liulangdongwuJinkuangUploadError(data){
            ...
            wuyong(id) {
                ...
                _this.$confirm(`确定    操作?`, "提示", {confirmButtonText: "确定",cancelButtonText: "取消",type: "warning"
                    ...
                    _this.$http({
                        url: "liulangdongwuJinkuang/update",
                        method: "post",
                        data: {
                            id:id,
