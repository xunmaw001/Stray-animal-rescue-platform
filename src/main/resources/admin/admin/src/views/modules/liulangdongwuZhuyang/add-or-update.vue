    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="liulangdongwuId" name="liulangdongwuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="助养金额" prop="liulangdongwuZhuyangMoney">
                       <el-input v-model="ruleForm.liulangdongwuZhuyangMoney"
                                 placeholder="助养金额" clearable  :readonly="ro.liulangdongwuZhuyangMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="助养金额" prop="liulangdongwuZhuyangMoney">
                           <el-input v-model="ruleForm.liulangdongwuZhuyangMoney"
                                     placeholder="助养金额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    liulangdongwuZhuyangMoney: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    liulangdongwuId: '',
                    liulangdongwuZhuyangMoney: '',
                    insertTime: '',
                },
                ...
                rules: {
                   ...
                   liulangdongwuZhuyangMoney: [
                              { required: true, message: '助养金额不能为空', trigger: 'blur' },
                   ...
                   insertTime: [
                              { required: true, message: '助养时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `liulangdongwuZhuyang/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`liulangdongwuZhuyang/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.liulangdongwuZhuyangCrossAddOrUpdateFlag = false;
                                        this.parent.search();
