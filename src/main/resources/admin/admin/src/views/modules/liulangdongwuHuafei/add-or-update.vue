    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="liulangdongwuId" name="liulangdongwuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="流浪动物花费编号" prop="liulangdongwuHuafeiUuidNumber">
                       <el-input v-model="ruleForm.liulangdongwuHuafeiUuidNumber"
                                 placeholder="流浪动物花费编号" clearable  :readonly="ro.liulangdongwuHuafeiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="流浪动物花费编号" prop="liulangdongwuHuafeiUuidNumber">
                           <el-input v-model="ruleForm.liulangdongwuHuafeiUuidNumber"
                                     placeholder="流浪动物花费编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="花费标题" prop="liulangdongwuHuafeiName">
                       <el-input v-model="ruleForm.liulangdongwuHuafeiName"
                                 placeholder="花费标题" clearable  :readonly="ro.liulangdongwuHuafeiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="花费标题" prop="liulangdongwuHuafeiName">
                           <el-input v-model="ruleForm.liulangdongwuHuafeiName"
                                     placeholder="花费标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.liulangdongwuHuafeiFile" label="附件" prop="liulangdongwuHuafeiFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.liulangdongwuHuafeiFile?$base.url+ruleForm.liulangdongwuHuafeiFile:''"
                                @change="liulangdongwuHuafeiFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.liulangdongwuHuafeiFile" label="附件" prop="liulangdongwuHuafeiFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.liulangdongwuHuafeiFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="花费金额" prop="liulangdongwuHuafeiMoney">
                       <el-input v-model="ruleForm.liulangdongwuHuafeiMoney"
                                 placeholder="花费金额" clearable  :readonly="ro.liulangdongwuHuafeiMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="花费金额" prop="liulangdongwuHuafeiMoney">
                           <el-input v-model="ruleForm.liulangdongwuHuafeiMoney"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="消费类型" prop="liulangdongwuHuafeiTypes">
                        <el-select v-model="ruleForm.liulangdongwuHuafeiTypes" :disabled="ro.liulangdongwuHuafeiTypes" placeholder="请选择消费类型">
                            <el-option
                                v-for="(item,index) in liulangdongwuHuafeiTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="消费类型" prop="liulangdongwuHuafeiValue">
                        <el-input v-model="ruleForm.liulangdongwuHuafeiValue"
                            placeholder="消费类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.huafeiTime"  class="input" label="花费时间" prop="huafeiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.huafeiTime"
                                type="datetime"
                                placeholder="花费时间"
                                :disabled="ro.huafeiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.huafeiTime" label="花费时间" prop="huafeiTime">
                            <span v-html="ruleForm.huafeiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.liulangdongwuHuafeiContent"  label="花费缘由" prop="liulangdongwuHuafeiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.liulangdongwuHuafeiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.liulangdongwuHuafeiContent" label="花费缘由" prop="liulangdongwuHuafeiContent">
                            <span v-html="ruleForm.liulangdongwuHuafeiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    liulangdongwuHuafeiUuidNumber: false,
                    liulangdongwuHuafeiName: false,
                    liulangdongwuHuafeiFile: false,
                    liulangdongwuHuafeiMoney: false,
                    liulangdongwuHuafeiTypes: false,
                    huafeiTime: false,
                    liulangdongwuHuafeiContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    liulangdongwuId: '',
                    liulangdongwuHuafeiUuidNumber: new Date().getTime(),
                    liulangdongwuHuafeiName: '',
                    liulangdongwuHuafeiFile: '',
                    liulangdongwuHuafeiMoney: '',
                    liulangdongwuHuafeiTypes: '',
                    huafeiTime: '',
                    liulangdongwuHuafeiContent: '',
                    insertTime: '',
                },
                liulangdongwuHuafeiTypesOptions : [],
                ...
                rules: {
                   ...
                   liulangdongwuHuafeiUuidNumber: [
                              { required: true, message: '流浪动物花费编号不能为空', trigger: 'blur' },
                          ],
                   liulangdongwuHuafeiName: [
                              { required: true, message: '花费标题不能为空', trigger: 'blur' },
                          ],
                   liulangdongwuHuafeiFile: [
                   ...
                   liulangdongwuHuafeiContent: [
                              { required: true, message: '花费缘由不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=liulangdongwu_huafei_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.liulangdongwuHuafeiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `liulangdongwuHuafei/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.liulangdongwuChange(data.data.liulangdongwuId)
                        _this.ruleForm.liulangdongwuHuafeiContent = _this.ruleForm.liulangdongwuHuafeiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.liulangdongwuHuafeiContent = this.ruleForm.liulangdongwuHuafeiContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`liulangdongwuHuafei/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.liulangdongwuHuafeiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            liulangdongwuHuafeiFileUploadChange(fileUrls){
                this.ruleForm.liulangdongwuHuafeiFile = fileUrls;
                this.addEditUploadStyleChange()
            },
