    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="申请领养编号" prop="liulangdongwuOrderUuidNumber">
                       <el-input v-model="ruleForm.liulangdongwuOrderUuidNumber"
                                 placeholder="申请领养编号" clearable  :readonly="ro.liulangdongwuOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="申请领养编号" prop="liulangdongwuOrderUuidNumber">
                           <el-input v-model="ruleForm.liulangdongwuOrderUuidNumber"
                                     placeholder="申请领养编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="快递公司" prop="liulangdongwuOrderCourierName">
                       <el-input v-model="ruleForm.liulangdongwuOrderCourierName"
                                 placeholder="快递公司" clearable  :readonly="ro.liulangdongwuOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="快递公司" prop="liulangdongwuOrderCourierName">
                           <el-input v-model="ruleForm.liulangdongwuOrderCourierName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="快递单号" prop="liulangdongwuOrderCourierNumber">
                       <el-input v-model="ruleForm.liulangdongwuOrderCourierNumber"
                                 placeholder="快递单号" clearable  :readonly="ro.liulangdongwuOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="快递单号" prop="liulangdongwuOrderCourierNumber">
                           <el-input v-model="ruleForm.liulangdongwuOrderCourierNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="领养状态" prop="liulangdongwuOrderTypes">
                        <el-select v-model="ruleForm.liulangdongwuOrderTypes" :disabled="ro.liulangdongwuOrderTypes" placeholder="请选择领养状态">
                            <el-option
                                v-for="(item,index) in liulangdongwuOrderTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="领养状态" prop="liulangdongwuOrderValue">
                        <el-input v-model="ruleForm.liulangdongwuOrderValue"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.liulangdongwuOrderYesnoTypes" label="申请状态" prop="liulangdongwuOrderYesnoTypes">
                        <el-input v-model="ruleForm.liulangdongwuOrderYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.liulangdongwuOrderYesnoText" label="审核意见" prop="liulangdongwuOrderYesnoText">
                        <span v-html="ruleForm.liulangdongwuOrderYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.liulangdongwuOrderShenheTime" label="审核时间" prop="liulangdongwuOrderShenheTime">
                        <span v-html="ruleForm.liulangdongwuOrderShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    liulangdongwuOrderUuidNumber: false,
                    addressId: false,
                    liulangdongwuId: false,
                    yonghuId: false,
                    liulangdongwuOrderCourierName: false,
                    liulangdongwuOrderCourierNumber: false,
                    liulangdongwuOrderTypes: false,
                    liulangdongwuOrderYesnoTypes: false,
                    liulangdongwuOrderYesnoText: false,
                    liulangdongwuOrderShenheTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    liulangdongwuOrderUuidNumber: new Date().getTime(),
                    addressId: '',
                    liulangdongwuId: '',
                    yonghuId: '',
                    liulangdongwuOrderCourierName: '',
                    liulangdongwuOrderCourierNumber: '',
                    liulangdongwuOrderTypes: '',
                    liulangdongwuOrderYesnoTypes: '',
                    liulangdongwuOrderYesnoText: '',
                    liulangdongwuOrderShenheTime: '',
                    insertTime: '',
                },
                liulangdongwuOrderTypesOptions : [],
                liulangdongwuOrderYesnoTypesOptions : [],
                addressOptions : [],
                liulangdongwuOptions : [],
                yonghuOptions : [],
                rules: {
                   liulangdongwuOrderUuidNumber: [
                              { required: true, message: '申请领养编号不能为空', trigger: 'blur' },
                          ],
                   addressId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=liulangdongwu_order_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.liulangdongwuOrderTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=liulangdongwu_order_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.liulangdongwuOrderYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`liulangdongwuOrder/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.liulangdongwuOrderCrossAddOrUpdateFlag = false;
                                        this.parent.search();
