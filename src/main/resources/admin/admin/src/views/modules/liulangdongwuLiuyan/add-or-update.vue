    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="liulangdongwuLiuyanText">
                        <el-input type="textarea"  :readonly="ro.liulangdongwuLiuyanText" v-model="ruleForm.liulangdongwuLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.liulangdongwuLiuyanText" label="留言内容" prop="liulangdongwuLiuyanText">
                            <span v-html="ruleForm.liulangdongwuLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.liulangdongwuId = true;//流浪动物
                this.ro.yonghuId = true;//用户
                this.ro.liulangdongwuLiuyanText = true;//留言内容
            }
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `liulangdongwuLiuyan/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`liulangdongwuLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.liulangdongwuLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
