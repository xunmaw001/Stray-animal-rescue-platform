...
var centerMenu = [
    ...
    ,{
        name: '流浪动物收藏',
        url: '../liulangdongwuCollection/list.html'
    }
    ,{
        name: '流浪动物近况',
        url: '../liulangdongwuJinkuang/list.html'
    }
    ,{
        name: '流浪动物领养',
        url: '../liulangdongwuOrder/list.html'
    }
    ,{
        name: '流浪动物助养',
        url: '../liulangdongwuZhuyang/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '流浪动物',
        url: './pages/liulangdongwu/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/liulangdongwujiuzhu/admin/dist/index.html#/login";
