...
public class LiulangdongwuOrderView extends LiulangdongwuOrderEntity implements Serializable {
	...
	*/
	...
	private String liulangdongwuOrderValue;
	/**
	* 申请状态的值
	*/
	...
	* 获取： 领养状态的值
	*/
	public String getLiulangdongwuOrderValue() {
		return liulangdongwuOrderValue;
	}
	/**
	* 设置： 领养状态的值
	*/
	public void setLiulangdongwuOrderValue(String liulangdongwuOrderValue) {
		this.liulangdongwuOrderValue = liulangdongwuOrderValue;
	}
	//当前表的
	/**
	* 获取： 申请状态的值
	...
	*/
	...
	public String toString() {
		return "LiulangdongwuOrderView{" +
			", liulangdongwuOrderValue=" + liulangdongwuOrderValue +
			", liulangdongwuOrderYesnoValue=" + liulangdongwuOrderYesnoValue +
