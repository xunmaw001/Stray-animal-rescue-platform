...
public class LiulangdongwuJinkuangView extends LiulangdongwuJinkuangEntity implements Serializable {
	...
	* 流浪动物状态的值
	*/
	@ColumnInfo(comment="流浪动物状态的字典表值",type="varchar(200)")
	private String liulangdongwuJinkuangValue;
	...
	public LiulangdongwuJinkuangView() {

	}

	public LiulangdongwuJinkuangView(LiulangdongwuJinkuangEntity liulangdongwuJinkuangEntity) {
		try {
			BeanUtils.copyProperties(this, liulangdongwuJinkuangEntity);
	...
	* 获取： 流浪动物状态的值
	*/
	public String getLiulangdongwuJinkuangValue() {
		return liulangdongwuJinkuangValue;
	}
	/**
	* 设置： 流浪动物状态的值
	*/
	public void setLiulangdongwuJinkuangValue(String liulangdongwuJinkuangValue) {
		this.liulangdongwuJinkuangValue = liulangdongwuJinkuangValue;
	}
	...
	public String toString() {
		return "LiulangdongwuJinkuangView{" +
			", liulangdongwuJinkuangValue=" + liulangdongwuJinkuangValue +
