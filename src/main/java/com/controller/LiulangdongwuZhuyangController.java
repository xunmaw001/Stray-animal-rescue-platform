...
//            liulangdongwuZhuyang.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R save( String fileName, HttpServletRequest request){
        ...
        try {
            List<LiulangdongwuZhuyangEntity> liulangdongwuZhuyangList = new ArrayList<>();//上传的东西
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            LiulangdongwuZhuyangEntity liulangdongwuZhuyangEntity = new LiulangdongwuZhuyangEntity();
//                            liulangdongwuZhuyangEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            liulangdongwuZhuyangEntity.setLiulangdongwuId(Integer.valueOf(data.get(0)));   //流浪动物 要改的
//                            liulangdongwuZhuyangEntity.setLiulangdongwuZhuyangMoney(data.get(0));                    //助养金额 要改的
//                            liulangdongwuZhuyangEntity.setInsertTime(date);//时间
//                            liulangdongwuZhuyangEntity.setCreateTime(date);//时间
                            liulangdongwuZhuyangList.add(liulangdongwuZhuyangEntity);
                        ...
                        //查询是否重复
                        liulangdongwuZhuyangService.insertBatch(liulangdongwuZhuyangList);
                        return R.ok();
                    }
                }
            }
    ...
    */
    @RequestMapping("/add")
    public R add(@RequestBody LiulangdongwuZhuyangEntity liulangdongwuZhuyang, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,liulangdongwuZhuyang:{}",this.getClass().getName(),liulangdongwuZhuyang.toString());

        if(liulangdongwuZhuyang.getLiulangdongwuId() == null)
            return R.error("查不到流浪动物");
        LiulangdongwuEntity liulangdongwuEntity = liulangdongwuService.selectById(liulangdongwuZhuyang.getLiulangdongwuId());
        ...
        YonghuEntity yong = yonghuService.selectById(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        double balance = yong.getNewMoney() - liulangdongwuZhuyang.getLiulangdongwuZhuyangMoney();
        if(balance<0){
            return R.error("当前账户余额不够此次助养,请充值后再助养");
        }
        yong.setNewMoney(balance);
        yonghuService.updateById(yong);
