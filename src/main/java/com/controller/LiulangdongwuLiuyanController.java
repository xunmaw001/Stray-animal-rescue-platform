...
public class LiulangdongwuLiuyanController {
    ...
    private static final String TABLE_NAME = "liulangdongwuLiuyan";
    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(liulangdongwuLiuyan !=null){
            ...
            //级联表 用户
            //级联表
            YonghuEntity yonghu = yonghuService.selectById(liulangdongwuLiuyan.getYonghuId());
            if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody LiulangdongwuLiuyanEntity liulangdongwuLiuyan, HttpServletRequest request){
        ...
        if(false)
            ...
            liulangdongwuLiuyan.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R update(@RequestBody LiulangdongwuLiuyanEntity liulangdongwuLiuyan, HttpServletRequest request) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        logger.debug("update方法:,,Controller:{},,liulangdongwuLiuyan:{}",this.getClass().getName(),liulangdongwuLiuyan.toString());
        LiulangdongwuLiuyanEntity oldLiulangdongwuLiuyanEntity = liulangdongwuLiuyanService.selectById(liulangdongwuLiuyan.getId());//查询原先数据
...
//            liulangdongwuLiuyan.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        List<LiulangdongwuLiuyanEntity> oldLiulangdongwuLiuyanList =liulangdongwuLiuyanService.selectBatchIds(Arrays.asList(ids));//要删除的数据
...
//                            liulangdongwuLiuyanEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
