...
public class LiulangdongwuCollectionController {
    ...
    private static final String TABLE_NAME = "liulangdongwuCollection";
    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(liulangdongwuCollection !=null){
            ...
            //级联表 用户
            //级联表
            YonghuEntity yonghu = yonghuService.selectById(liulangdongwuCollection.getYonghuId());
            if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody LiulangdongwuCollectionEntity liulangdongwuCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            liulangdongwuCollection.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<LiulangdongwuCollectionEntity> queryWrapper = new EntityWrapper<LiulangdongwuCollectionEntity>()
            ...
            .eq("yonghu_id", liulangdongwuCollection.getYonghuId())
    ...
    */
    ...
    public R update(@RequestBody LiulangdongwuCollectionEntity liulangdongwuCollection, HttpServletRequest request) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        logger.debug("update方法:,,Controller:{},,liulangdongwuCollection:{}",this.getClass().getName(),liulangdongwuCollection.toString());
        LiulangdongwuCollectionEntity oldLiulangdongwuCollectionEntity = liulangdongwuCollectionService.selectById(liulangdongwuCollection.getId());//查询原先数据
...
//            liulangdongwuCollection.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        List<LiulangdongwuCollectionEntity> oldLiulangdongwuCollectionList =liulangdongwuCollectionService.selectBatchIds(Arrays.asList(ids));//要删除的数据
...
//                            liulangdongwuCollectionEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
    ...
    */
    ...
    public R add(@RequestBody LiulangdongwuCollectionEntity liulangdongwuCollection, HttpServletRequest request){
        ...
        Wrapper<LiulangdongwuCollectionEntity> queryWrapper = new EntityWrapper<LiulangdongwuCollectionEntity>()
            ...
            .eq("yonghu_id", liulangdongwuCollection.getYonghuId())
            .eq("liulangdongwu_collection_types", liulangdongwuCollection.getLiulangdongwuCollectionTypes())
//            .notIn("liulangdongwu_collection_types", new Integer[]{102})
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        LiulangdongwuCollectionEntity liulangdongwuCollectionEntity = liulangdongwuCollectionService.selectOne(queryWrapper);
        if(liulangdongwuCollectionEntity==null){
